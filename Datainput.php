        ...
        function confirmSubmit(row) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const no_ir = urlParams.get('no_ir');

                    if (no_ir) {
                        formData.append('no_ir', no_ir);
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (Array.isArray(response)) {
                                // Loop untuk menampilkan pesan satu per satu
                                ...
                                // Jika bukan array, tampilkan pesan error
                                Swal.fire({
                                    title: 'Gagal!',
